...
<div align="center" style="margin: 20px 0; overflow-x: auto; padding: 10px 0;">
  <pre style="display: inline-block; text-align: left; font-size: 14px; font-family: 'Courier New', monospace; white-space: pre; line-height: 1.4;">
                    +------------------------------------------------------------------------+
